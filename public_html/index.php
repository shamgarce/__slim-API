...
$app->group('/v1', function () use ($app) {
	...
	$app->group('/a', function () use ($app) {
		$app->post('/useradd', function () use ($app) {
			$req = $app->request;
			$config['v'] = 'v1';
			$config['instance'] = 'ca';
			$config['action'] = 'useradd';
			ApiBase::run($config);
		});
	...
	$app->get('/token/:ulogin/:upwd', function ($ulogin,$upwd) use ($app) {
		$config['v'] = 'v1';
		$config['instance'] = 'gt';
		$config['action']   = 'ver';
		$config['debug'] 	= '1';
...
//echo $upwd;
	...
	$app->get('/to/:ulogin/:upwd', function ($ulogin,$upwd) use ($app) {
		$config['v'] = 'v1';
		$config['instance'] = 'gt';
		$config['action']   = 'ver2';
		$config['debug'] 	= '0';
