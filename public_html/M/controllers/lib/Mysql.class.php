...
final class MysqlConfig{    //不允许被继承
    private static $MysqlConfig = array(                          //数据库相关
    //------------------------------数据库信息配置
...
//        $dbconfig = Easy\Expansion\MysqlConfig::getconfig();          //读取配置
...
//        $ms = \Easy\Expansion\MysqlConfig::getInstance()->getconfig();
//        !(self::$instance instanceof self)&&self::$instance = new Mysql($ms);
