...
$mysql_set['default']['hostname'] = '127.0.0.1';
$mysql_set['default']['username'] = 'root';
$mysql_set['default']['password'] = '123';
$mysql_set['default']['database'] = 'ns';
...
//        $this->cls_mysql($config['dbhost'], $config['dbuser'], $config['dbpw'], $config['dbname'], $config['charset'], $config['pconnect'], $config['quiet']);
        $this->cls_mysql(
            Dbv3_config::$hostname,
            Dbv3_config::$username,
            Dbv3_config::$password,
            Dbv3_config::$database,

            Dbv3_config::$charset,
            Dbv3_config::$pconnect,
            Dbv3_config::$quiet
