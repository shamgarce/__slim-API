    ...
    <div class="tile-area tile-area-dark">
        ...
        <div class="user-id">
            <div class="user-id-image">
                <a href="list.html"><span class="icon-user no-display1"></span></a>
            </div>
        ...
        <div class="tile-group six">
			<div class="tile-group-title">System</div>
            <a href="list.html" class="tile double bg-lightBlue live" data-role="live-tile" data-effect="slideUp" data-click="transform">
                <div class="tile-content email">
                    <div class="email-image">
                        <img src="/A/Metro/images/obama.jpg">
                    </div>
                ...
                <div class="tile-content email">
                    <div class="email-image">
                        <img src="/A/Metro/images/jolie.jpg">
                    </div>
                    <div class="email-data">
                ...
                <div class="tile-content email">
                    <div class="email-image">
                        <img src="/A/Metro/images/shvarcenegger.jpg">
                    </div>
                    <div class="email-data">
            ...
            <div class="tile" data-click="transform">
                <div class="tile-content image">
                    <img src="/A/Metro/images/clouds.jpg">
                </div>
                <div class="brand">
            ...
            <div class="tile double" data-click="transform">
                <div class="tile-content image-set">
                    <img src="/A/Metro/images/jeki_chan.jpg">
                    <img src="/A/Metro/images/jek_vorobey.jpg">
                    <img src="/A/Metro/images/jolie.jpg">
                    <img src="/A/Metro/images/obama.jpg">
                    <img src="/A/Metro/images/shvarcenegger.jpg">
                </div>
            ...
            <a class="tile double bg-lightBlue" data-click="transform">
                <div class="tile-content image">
                    <img src="/A/Metro/images/windows_8_default_13_wallpaper.jpg">
                </div>
                <div class="brand">
        ...
        <div class="tile-group double">
            ...
            <div class="tile bg-dark" data-click="transform">
                <div class="tile-content icon">
                    <img src="/A/Metro/images/Crysis-2-icon.png">
                </div>
                <div class="brand">
            ...
            <div class="tile bg-dark" data-click="transform">
                <div class="tile-content icon">
                    <img src="/A/Metro/images/Battlefield_4_Icon.png">
                </div>
                <div class="brand">
            ...
            <div class="tile bg-dark" data-click="transform">
                <div class="tile-content icon">
                    <img src="/A/Metro/images/grid2.png">
                </div>
                <div class="brand">
        ...
        <div class="tile-group double">
            <div class="tile double" data-click="transform">
                <div class="tile-content image-set">
                    <img src="/A/Metro/images/1.jpg">
                    <img src="/A/Metro/images/2.jpg">
                    <img src="/A/Metro/images/3.jpg">
                    <img src="/A/Metro/images/4.jpg">
                    <img src="/A/Metro/images/5.jpg">
                </div>
            </div>
