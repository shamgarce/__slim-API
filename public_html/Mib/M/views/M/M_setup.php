...
<a class="button success listsort">排序</a>
<a href="/M/setup" class="button warning">设置</a>
<a href="tree.html" class="button warning">TREE</a>

<a href="ini.html" class="button warning">start</a>
<a href="list.html" class="button warning">list</a>
<a href="temp.html" class="button warning">temp</a>
<a href="tree.html" class="button warning">tree</a>
...
Nullam libero odio, lacinia vel dignissim sed, consequat ac nisi. Ut at mauris sit amet sem dapibus pretium sit amet sed orci. Quisque tincidunt sodales sollicitudin. Ut purus odio, imperdiet ut laoreet ac, placerat vel ante. 
</p>  
...
<?php foreach($rc as $key=>$value){ ?>
    <tr>
      ...
      <td><span class="input-control text info-state">
        <input type="text" placeholder="type text" class="b" value="<?php echo $value['group_title'] ?>">
      </span>
        </td>
      <td><span class="input-control text info-state">
        <input type="text" placeholder="type text" class="a" value="<?php echo $value['group_num'] ?>">
      </span></td>
      <td><span class="input-control text info-state">
        <input type="text" placeholder="type text" class="c" value="<?php echo $value['group_dis'] ?>">
      </span></td>
...
<?php }?>
    ...
    <tr>
      <td colspan="5">
<a class="button bg-darkRed fg-white">提交</a></td>
      </tr>
    <tr>
      <td colspan="5">数量填写
