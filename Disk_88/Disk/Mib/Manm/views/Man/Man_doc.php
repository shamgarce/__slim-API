      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="/Manm/index">路由</a></li>
            <li class="active"><a href="/Manm/doc">文档</a></li>
...
<tr>
  <td>  <a href="/Manm/doc/v1" type="button" class="btn btn-primary" <?php if($ver === 'v1' && $mm == ''){echo 'disabled';}?>>版本 v1</a>
  <a href="/Manm/doc/v3" type="button" class="btn btn-primary" <?php if($ver === 'v3' && $mm == ''){echo 'disabled';}?>>版本 v3</a></td>
</tr>
<tr>
  <td>模块 : 
<?php
...
?>
<a href="/Manm/doc/<?php echo $ver;?>/<?php echo $key;?>" type="button" class="btn btn-default" <?php if($mm === $key){echo 'disabled';}?>><?php echo $key;?></a>
<?php
}
?>
</td>
...
执行时间 <strong>{elapsed_time}</strong> 秒
    ...
    <script src="http://58.30.248.98:88/A/artDialog4.1.7/artDialog.js?skin=default"></script>
    <script src="http://58.30.248.98:88/A/CK.js"></script>
